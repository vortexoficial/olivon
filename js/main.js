...
(function () {
  ...
  (function avaliacoes() {
    ...
    /* o card é só a arte, uma versão por tema; ela troca junto com o botão */
    function arteDoTema() {
    ...
    if (!arte) { card.remove(); }
      ...
      card.innerHTML = '<img class="palco-figura" id="palcoArte" src="' + esc(arte) + '" alt="" loading="lazy" decoding="async">';
